        ...
        >
          <Modal.Content>
            ...
            >
              ...
              Du kannst dieser Story einen Community Step hinzufügen. Dieser muss von den Autoren genehmigt werden und wird dann in die Story eingefügt und angezeigt
              <div className='flex flex-row justify-end gap-4'>
                <Button onClick={() => setIsOpen(false)} variant={'inverse'}>Abbrechen</Button>
                <Button onClick={() => handleAddCommunityStep()}>Hinzufügen</Button>
            ...
            >
              ...
              <div className='flex justify-between'>
                <Button onClick={()=> setContentType('')} variant={'inverse'}>Zurück</Button>
                <Button onClick={()=> setContentType('addSlide')}>Weiter</Button>
            ...
            <div>
                {/* @ts-ignore */}
              <ShowStepWithContents setContentType={setContentType} setIsOpen={setIsOpen} setStepSuggestion = {setStepSuggestion} stepId={stepSuggestion?.id} stepSuggestion = {stepSuggestion} storyId={story.id}/>
            </div>
            </CSSTransition>
            <CSSTransition
              appear 
