...
export default function StepSuggestionCard ({ stepSuggestion, handleReject, handleAccept, loading } : Props) {
            ...
            <Card.Footer>
                <div className="flex items-center justify-between">
                    ...
                    <Button
                        ...
                        startIcon={loading ?   <svg className="animate-spin h-5 w-5 mr-3 ..." viewBox="0 0 24 24">
                          </svg> : <CheckIcon className="w-5" />}
                    >
