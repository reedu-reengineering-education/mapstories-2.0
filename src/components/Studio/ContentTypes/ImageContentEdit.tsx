...
export function ImageContentEdit({
  storyStepId,
  lng,
  stepItem,
  ...props
}: ImageContentEditProps) {
    ...
    <div>
      ...
      {stepItem && (
        <div className="m-2 flex justify-center">
          <Image
            alt={stepItem.image}
            height={stepItem.imageHeight}
            src={stepItem.image}
            width={stepItem.imageWidth}
          />
        </div>
      )}
        ...
        {(showInputs || stepItem) && (
          <div>
            <div>
              ...
              <Input
                defaultValue={stepItem ? stepItem.imageHeight : 200}
                onChange={e => {
            ...
            <div>
              ...
              <Input
                defaultValue={stepItem ? stepItem.imageWidth : 200}
