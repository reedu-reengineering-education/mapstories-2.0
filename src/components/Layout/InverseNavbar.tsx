...
function MobileNav({
  ...
  return (
    <div
      className={cx(
        'animate-in slide-in-from-bottom-80 fixed inset-0 top-16 z-[9999] grid h-[calc(100vh-4rem)] w-[50%] grid-flow-row auto-rows-max  p-6 pb-32 lg:hidden',
      )}
    >
      <div className="re-basic-box relative grid gap-6 bg-white p-4">
