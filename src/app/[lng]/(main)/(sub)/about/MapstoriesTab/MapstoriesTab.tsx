      ...
      <CardContent>
        ...
        <div className="flex flex-col lg:flex-row  lg:justify-evenly">
          ...
          <div className="flex flex-1 flex-col  items-center gap-4 p-8">
            ...
            <a
              className="transition duration-300 ease-in-out hover:scale-105 flex justify-center align-baseline"
          ...
          <div className="text-center">
            ...
            <div className='flex flex-col lg:flex-row align-baseline'>
              ...
              >
                <Image alt="Kunst & Kultur NRW" className="kulturWissenschaft" src={kulturWissenschaftNRW} />
              </a>
            </div>
              <div className="flex flex-1 flex-col  items-center gap-4 p-8 lg:border-l-2 my-2 lg:border-zinc-300">
              {/* @ts-ignore */}
